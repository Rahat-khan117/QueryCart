    ...
    <div className="px-4 md:px-10 lg:px-14">
      <div className="mt-10 px-4">
        ...
        <div className="px-4 py-4 bg-white rounded-3xl relative mt-4">
           ...
           <button className="btn bg-[#3c5de3] text-white lg:text-2xl text-xl lg:px-14 lg:py-5 rounded-2xl absolute md:bottom-[38%] bottom-[23%] md:left-[41%] left-[27%] sm:bottom-[30%] sm:left-[37%]"> Add Queries</button>
        </div>
      </div>
    </div>
  );
